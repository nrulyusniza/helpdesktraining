...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Edit Reporting Person</li>
    </ol>
</nav>
...
<div class="col-12">
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Edit Reporting Person</h5>
        ...
        <div class="card-body">
            ...
            @method('PUT')
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="rptperson_name" value="{{ $reportingperson->rptpers_name}}">
                    </div>
                </div>
                <div class="row mb-3">
