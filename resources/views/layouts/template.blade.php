...
<html
  ...
  <head>
    ...
    <title>VERSION 3 Dashboard | NCO Helpdesk</title>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{ route('mydashboard') }}" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold ms-2">V3 NCO Helpdesk</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
              <a href="{{ route('mydashboard') }}" class="menu-link">
            ...
            <li class="menu-item">
              <a href="{{ route('kbcategorys.allkbcategory') }}" class="menu-link">
            ...
            <li class="menu-item">
              <a href="{{ route('tab') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-user-pin"></i>
