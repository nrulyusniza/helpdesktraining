...
<html
  ...
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('pages/assets/img/favicon/favicon.ico') }}" />
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="{{ route('home') }}" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bold">NCO Helpdesk</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to NCO Helpdesk! 👋</h4>
