        ...
        <div class="card-body">
            ...
            @method('PUT')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="kb_title" value="{{ $knowledgebase->kb_title }}">
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label" for="basic-default-name">Content</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="kb_content" value="{{ $knowledgebase->kb_content }}">
                    </div>
                </div>
